...
and human-provided draft credits; it is not generated by the CLI. Starting the
plan creates the session. Use the returned session ID for every later session
command.

...
describe('asset release config', () => {
  it('loads the pinned release config with the approved source SHA', () => {
    ...
    writeFileSync(
      ...
      JSON.stringify({
        tag: 'assets-v2026.08.01-color-links-v1',
        sourceRepository:
          'ochowei/Universal-LPC-Spritesheet-Character-Generator',
        sourceSha: '9c190fb596f855d1adc253454786536993829b84',
        manifestUrl:
          'https://github.com/ochowei/Universal-LPC-Spritesheet-Character-Generator/releases/download/assets-v2026.08.01-color-links-v1/asset-manifest.json',
        manifestSha256:
          '4e039fa8b48e1f1e2ed37b5c8b8037d1f058d5c33234ac82bcf7dd41c7004fcc',
        tarballUrl:
          'https://github.com/ochowei/Universal-LPC-Spritesheet-Character-Generator/releases/download/assets-v2026.08.01-color-links-v1/lpc-runtime-zips.tar.gz',
        tarballSha256:
    ...
    expect(loadReleaseConfig(repoRoot).sourceSha).toBe(
      '9c190fb596f855d1adc253454786536993829b84',
    );

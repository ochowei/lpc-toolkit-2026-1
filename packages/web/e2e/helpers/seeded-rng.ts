/** Named random seed used to generate one upstream-parity case. */
export interface SeededCase {
  readonly name: string;
  readonly seed: number;
}

/** Fixed URL-hash parity case with provenance for debugging regressions. */
...
/** Deterministic seeds sampled by the random upstream-parity spec. */
...
/** Small fixed hash used to verify the parity harness with a minimal layer set. */
...
/** User-reported mismatch kept as a regression case for deployed parity. */
...
/** Deterministic pseudo-random number generator for repeatable E2E cases. */

...
| 2 | fixed | `54cccc722` `4c5bbc535` | `rtk pnpm --filter @lpc-toolkit/web test -- spritesheet-export.test.ts zip-export.test.ts` | PASS |
...
| 11 | fixed | `e534731a5` | `rtk pnpm --filter @lpc-toolkit/web test -- attribution-manifest.test.ts attribution-summary.test.ts` | PASS |
...
| 15 | documented approved exception | `192a464e4` `2007830ac` | `rtk pnpm --filter @lpc-toolkit/web test -- attribution-manifest.test.ts readme-architecture-docs.test.ts` | PASS |
